...
contract MyEpicNFT is ERC721URIStorage {
  ...
  string[] firstWords = ["Hairy", "Furry", "Shaved", "Smelly", "Yummy", "Hot"];
  string[] secondWords = ["Rabbit", "Turtle", "Hamster", "Cat", "Dog", "Chicken"];
  string[] thirdWords = ["Banana", "Apple", "Orange", "Pineapple", "Plum", "Watermelon"];
